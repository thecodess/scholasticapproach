...
export default function SignUp() {
  ...
  const handleSubmit = (event) => {
    ...
    if(!validator.isEmpty(firstName,{ ignore_whitespace: true }) && !validator.isEmpty(lastName,{ ignore_whitespace: true })&&validator.isEmail(email)&&validator.isMobilePhone(phone)&&!validator.isEmpty(password) ){
      const config = {
        headers: {
          "Access-Control-Allow-Origin": "*",
          "Access-Control-Allow-Methods": "GET,PUT,POST,DELETE,PATCH,OPTIONS"
        ...
        axios.post("/signup-user", {email,password,firstName,lastName,phone},config)
              .then(response=>{
                setLoading(false);
